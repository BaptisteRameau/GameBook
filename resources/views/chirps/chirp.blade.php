                            ...
                            <div class="relative text-left dropdown z-10 ml-3">
                                ...
                                <div class="opacity-0 invisible dropdown-menu transition-all duration-300 transform origin-top-right -translate-y-2 scale-95">
                                    <div class="absolute right-0 w-56 mt-2 origin-top-right bg-white  border-gray-200 divide-y divide-gray-100 rounded-md shadow-lg outline-none"  role="menu">
                                        <div class="py-1">
                                            <a href="{{ route('chirps.edit', $chirp) }}" tabindex="0" class="text-gray-700 flex justify-between w-full px-4 py-2 text-sm leading-5 text-left"  role="menuitem" >{{ __('Edit') }}</a>
                                            <form method="POST" action="{{ route('chirps.destroy', $chirp) }}"  class="text-gray-700 flex justify-between w-full px-4 py-2 text-sm leading-5 text-left">
                                                @csrf
                                                @method('delete')
